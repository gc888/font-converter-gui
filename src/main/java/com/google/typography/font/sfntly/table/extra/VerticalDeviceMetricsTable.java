...
/**
 * A Vertical Device Metrics table - 'vdmx'.
 *
 * @author raph@google.com (Raph Levien)
 * @see "ISO/IEC 14496-22:2015, section 5.7.2"
 */
public class VerticalDeviceMetricsTable extends Table {
  ...
  private VerticalDeviceMetricsTable(Header header, ReadableFontData data, int numGlyphs) {
    super(header, data);
  ...
  public static class Builder extends TableBasedTableBuilder<VerticalDeviceMetricsTable> {
    ...
    @Override
    protected VerticalDeviceMetricsTable subBuildTable(ReadableFontData data) {
      return new VerticalDeviceMetricsTable(header(), data, numGlyphs);
    }
